...
# Common etc
PRODUCT_COPY_FILES += \
    $(COMMON_PATH)/rootdir/system/vendor/etc/audio_effects.conf:system/vendor/etc/audio_effects.conf.bak \
...
# APN list
PRODUCT_COPY_FILES += \
    device/sample/etc/old-apns-conf.xml:system/etc/old-apns-conf.xml.bak \
    device/sample/etc/apns-full-conf.xml:system/etc/apns-conf.xml.bak
